...
namespace HomeOS.Hub.Apps.CameraImager
{
    ...
    public class CameraImager : ModuleBase
    {
        ...
        const string IMAGE_SUB_DIR_NAME = "images";
        ...
        public override void Start()
        {
            ...
            this.imagesDir = moduleInfo.WorkingDir() + "\\" + IMAGE_SUB_DIR_NAME;
            this.imagesBaseUrl = moduleInfo.BaseURL() + "/" + IMAGE_SUB_DIR_NAME;

            recordingServer = new WebFileServer(imagesDir, imagesBaseUrl, logger);
        ...
        public string[] GetRecordedCamerasList()
        {
            ...
            string[] cameraDirsArray = Directory.GetDirectories(this.imagesDir, "*", SearchOption.TopDirectoryOnly);
        ...
        private void ConvertLocalPathArrayToUrlArray(string[] fileArray, int countMax)
        {
            ...
            foreach (string filePath in fileArray)
            {
                ...
                string substr = /*"\\" +*/ IMAGE_SUB_DIR_NAME;
        ...
        private string[] GetTriggerImagesFromClipUrl(string clipUrl)
        {
            ...
            string relClipPath = clipUrl.Substring(this.imagesBaseUrl.Length);

            relClipPath = relClipPath.Replace('/', '\\');
            string clipPath = String.Format("{0}\\{1}", this.imagesDir, relClipPath);
        ...
        private string GetMediaFileName(string cameraName, MediaType mediaType)
        {
            ...
            string directory = directory = String.Format("{0}\\{1}\\{2}-{3}-{4}", this.imagesDir, cameraName, currTime.Year, currTime.Month, currTime.Day);
